...
// Кнопка в правом нижнем углу "Возвращение на вверх"
...
ymaps.ready(function () {
	var myMap = new ymaps.Map('map', {
			center: [41.29134517521288,69.26373752090358],
			zoom: 12
		}, {
		...
		myPlacemark = new ymaps.Placemark([41.26111476122832,69.24289943906683], {
			hintContent: 'AquaStyle',
			balloonContent: `
			<div>Ghbdk</div>
			`,
			...
			// Своё изображение иконки метки.
			iconImageHref: 'assets/img/contacts/as.png',
			// Размеры метки.
...
ymaps.ready(function () {
	var myMap = new ymaps.Map('map-2', {
			center: [41.26111476122832,69.24289943906683],
			zoom: 12
		}, {
			searchControlProvider: 'yandex#search'
		}),
...
ymaps.ready(function () {
	var myMap = new ymaps.Map('map-2-', {
			center: [41.26112843183171, 69.24287391650134],
			zoom: 12
		}, {
			searchControlProvider: 'yandex#search'
		}),
		...
		myPlacemark = new ymaps.Placemark(myMap.getCenter(), {
			hintContent: 'AquaStyle',
			balloonContent: 'Сборка и поставка пром фильтров для воды по Узбекистану'
		}, {
			// Опции.
			// Необходимо указать данный тип макета.
			iconLayout: 'default#image',
...
let myImageSlider = new Swiper('.text-slider', {
	// Стрелки
	navigation: {
